...
public class RisingoftheShieldHero {
    ...
    public static final String NAME = "Rising of the Shield Hero Mod";
    public static final String VERSION = "1.0.0";
    public static final String MC_VERSION = "[1.12.2]";

    public static final Logger LOGGER = LogManager.getLogger(RisingoftheShieldHero.MODID);
    public static final CreativeTabs Shield_Hero_Tab = new ShieldHeroTab("tabRisingoftheShieldHero");
